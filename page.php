...
<!-- ======================================================================================================= -->
<!-- ==================		PHP  | Start Article 37.0  |  Start Page       ================================= -->
<!-- ======================================================================================================= -->
	<div>
		<style>
            /* Start Article 37.0  |  Start Page */
			#article-37-0{
				padding-top: 9px;
			}
            #article-37-0 label.wp-block-search__label {
                display: none;
            }
            #article-37-0 input#wp-block-search__input-1 {
                background: no-repeat;
                backdrop-filter: blur(5px);
                color: var(--t-c-yellow-);
                padding: 0px 0px 0px 9px;
            }
            #article-37-0 button.wp-block-search__button {
                background: var(--theme-glass-4-)!important;
                color: var(--t-c-yellow-)!important;
            }
            #article-37-0 .search-bar {
                padding: 0px 0px 8px 0px;
            }
            #article-37-0 h2.search-h2 {
                text-align: center;
                color: var(--t-c-yellow-);
            }
            #article-37-0 h2.search-h2 span {
                font-weight: bold;
            }
			#article-37-0 .wrap {
			...
			#article-37-0 a.btn-read {
				color: var(--t-c-yellow-);
				font-weight: bold;
			}
			#article-37-0 .pagination {
				background: var(--theme-glass-2-);
				padding: 9px;
				border: 1px solid currentColor;
				backdrop-filter: blur(4px);
			}
			#article-37-0 .pagination span {
				margin-right: auto;
			}
			#article-37-0 .pagination .inactive {
				color: var(--t-c-white-);
				border: 1px solid currentColor;
				padding: 1px 5px;
				font-weight: bold;
			...
			#article-37-0 .pagination span.current {
				color: var(--t-c-yellow-);
				border: 1px solid currentColor;
				padding: 1px 5px;
				font-weight: bold;
            ...
            #article-37-0 .container.no-search {
                backdrop-filter: blur(5px);
                border: 1px solid currentColor;
            }
            #article-37-0 .no-search h2 {
                color: var(--t-c-yellow-);
            }
            /* End Article 37.0  |  End Page */
		</style>
		<article id="article-37-0">
            <!-- Start Article 37.0  |  Start Page -->
				<!-- ======================================================================================================= -->
				<?php
					...
					$custom_query_args = array(
						'post_type' => 'custom_poster_article', 
