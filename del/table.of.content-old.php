...
<!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ -->
	...
	$labels = array(
		...
		'singular_name'         => _x( 'Singular__', 'Post type _singular name', 'textdomain' ),
...
function our_theme_setup(){
	...
	register_post_type('post_type_name' , array(
		'labels' => array(
			'name' => 'Add Post Type',
			'add_new_item' => 'Add New Add Post Type',
		),
		'public' => true,
		'has_archive' => true,
		'supports' => array(
			'title', 'editor', 'thumbnail', 'excerpt', 'custom-fields', 'revisions', 'post-formats', 'author', 'comments'
		),
